                            ...
                            <table class="table table-striped" id="user_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">required_quantity</th>
                                        <th scope="col">name_of_owner</th>
                                        <th scope="col">blood_owner</th>
                                        <th scope="col">blood_bank</th>
                                        <th scope="col">date_donation</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['users'] as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->blood_owner}}</td>
                                            <td>{{ $row->blood_bank}}</td>
                                            <td>{{ $row->date_donation}}</td>
