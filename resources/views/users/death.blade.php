                            ...
                            <table class="table table-striped" id="user_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Iqama No/ National Id</th>
                                        <th scope="col">Mobile No.</th>
                                        <th scope="col">Bur/Disp. Status</th>
                                        <th scope="col">Burial/Dispatch Date</th>
                                        <th scope="col">Maqbara/Dispatched</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['users'] as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->iqama_no_or_national_id }}</td>
                                            <td>{{ $row->mobile_no2 }}</td>
                                            <td>{{ $row->bur_or_disp_status }}</td>
                                            <td>{{ $row->burial_or_dispatch_date }}</td>
                                            <td>{{ $row->maqbara_or_dispatched }}</td>
                                            <td>{{ $row->status }}</td>
                                            <td>{{ $row->remarks }}</td>
                                            <?php $user =  Auth::user();
                                           if ($user->login_type == "Admin") { ?>
                                           <td>
                                           <a href="{{route('users.create')}}" class="text-success mr-2">
